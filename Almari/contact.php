...
<div class="container-fluid" style="background:#f1f1f0;">
  ...
  <h3 class="innerheading">CONTACT</h3>
  <div class="line-center"></div>
  
  
  
  <div class="col-md-6 col-sm-6 col-xs-12"> <img src="images/contactus.png" class=" img-responsive center-block" /> </div>
    ...
    <div class="form-area">  
        <form role="form" name="contact_form" action="" id="contact_form" method="post">
        <br style="clear:both">
					...
					<div class="form-group">
						<input type="text" class="form-control required" id="contact" name="contact" placeholder="Phone Number" required>
					</div>
					<div class="form-group">
						<input type="text" class="form-control required" id="subject" name="subject" placeholder="Subject" required>
					</div>
                    <div class="form-group">
                    <textarea class="form-control required" type="textarea" id="message" name="message" placeholder="Message" maxlength="140" rows="7"></textarea>
                                           
                    </div>
            
					<input type="submit" name="submit" value="Submit" class="btn btn-primarynew pull-right"/> 
        </form>
