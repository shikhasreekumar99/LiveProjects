...
<div class="container-fluid" style="background:#f1f1f0;">
  ...
  <div class="container news">
    ...
    <div class="row">
      ...
      <div class="col-md-2 col-sm-2 col-xs-12 newsheading">APPLICATION NEWS</div>

      <?php

	  $res="SELECT * FROM `app_news`";
      ...
      <div class="col-md-10 col-sm-10 col-xs-12" style="padding:5px 2px;">
  ...
  <div class="container" >
    <div class="row">
      <h3 class="innerheading">DOWNLOAD</h3>
      <div class="line-center"></div>
      <div class="col-md-4">
        <div class="row">
        
       
          <div class="col-md-12"> <img src="images/nokiadialers.jpg" class="img-responsive" />
            <div class="row">
            
             <?php
		$result="SELECT * FROM `download` WHERE cat_id=1";
		...
		?>
              ...
              <div class="os">
                <div class="col-md-2 col-sm-2 col-xs-3" ><img src="almari_backend/<?=$row1['image'];?>" class="img-responsive center-block"  /> </div>
                <div class="col-md-6 col-sm-6 col-xs-3"><span class="itel"><?=$row1['title'];?></span><br />
                  operator code  <?=$row1['code'];?> </div>
                <a href="<?=$row1['url'];?>" target="_blank">
                <div class="col-md-4 col-sm-4 col-xs-6 dwnld_page">DOWNLOAD</div>
                </a> </div>
          ...
          <div class="col-md-12"> <img src="images/iphone.jpg" class="img-responsive" />
            <div class="row">
            <?php
		$result="SELECT * FROM `download` WHERE cat_id=4";
		$sql1=mysqli_query($con,$result);
		while($row1=mysqli_fetch_array($sql1))
		{
      ...
      <div class="col-md-4">
        <div class="row">
          <div class="col-md-12"> <img src="images/android.jpg" class="img-responsive" />
            <div class="row">
                <?php
		$result="SELECT * FROM `download` WHERE cat_id=2";
		$sql1=mysqli_query($con,$result);
		while($row1=mysqli_fetch_array($sql1))
		{
		...
		?>
          ...
          <div class="col-md-12"> <img src="images/windows.jpg" class="img-responsive" />
            <div class="row">
            
             <?php
		$result="SELECT * FROM `download` WHERE cat_id=5";
		$sql1=mysqli_query($con,$result);
		while($row1=mysqli_fetch_array($sql1))
		{
      ...
      <div class="col-md-4">
        <div class="row">
          <div class="col-md-12"> <img src="images/PC.jpg" class="img-responsive" />
            <div class="row">
            
            
              <?php
		$result="SELECT * FROM `download` WHERE cat_id=3";
		$sql1=mysqli_query($con,$result);
		while($row1=mysqli_fetch_array($sql1))
		{
...
<div class="container-fluid footer">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12 text-right pull-right mobalign">

        <div class="poweredby"> By AL-Mari voice Telecommunication & Systems <!--<a href="http://phitany.com" target="_blank"> web design company Kerala  </a>--> </div>
