...
-->              </ul>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="add_events.php"><i class="fa fa-circle-o"></i> Add Events</a></li>
                 <li>
                <a href="view_events.php"><i class="fa fa-circle-o"></i> Manage Events <!--<i class="fa fa-angle-left pull-right"></i>--></a>
                 <!-- <ul class="treeview-menu">
