	...
	<div class="c-layout-breadcrumbs-1 c-bgimage c-subtitle c-fonts-uppercase c-fonts-bold c-bg-img-center" style="background-image: url(images/bg-1.gif)">
		<div class="container">
			<div class="c-page-title c-pull-left">
				<h3 class="c-font-uppercase c-font-bold c-font-white c-font-20 c-font-slim">Home Cinema</h3>
				<h4 class="c-font-white c-font-thin c-opacity-07">
				Lifestyle Interio, Home Cinema</h4>
			</div>
			...
			<div class="row">
            	<div class="col-md-6">
					<div class="c-content-media-2-slider" data-slider="owl" data-single-item="true" data-auto-play="3000">
						...
						<div class="owl-carousel owl-theme c-theme owl-single">
							<div class="item">
								<div class="c-content-media-2 c-bg-img-center" style="background-image: url(images/service-13.jpg); min-height: 380px;">
								</div>
							</div>
							<div class="item">
								<div class="c-content-media-2 c-bg-img-center" style="background-image: url(images/service-14.jpg); min-height: 380px;">
								</div>
							</div>
							<div class="item">
								<div class="c-content-media-2 c-bg-img-center" style="background-image: url(images/service-15.jpg); min-height: 380px;">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-md-6">
					<div class="c-content-media-1 p0">
						<p>Now, more and more people are turning their ordinary TV rooms into home theatres. This used to involve a projector and a screen, and it was too expensive for most people to afford. But advances in technology have given people more choices for home theatre setups, and some people find that a home theatre is quieter and more convenient than a movie theatre -- and the picture and sound are great.</p>
                        <h3 class="c-left c-font-red">Benefits of home theatre</h3>
                        <ul class="c-content-list-1">
                        	<li>Huge picture (up to 300 inches!)</li>
                            <li>Phenomenally bright image</li>
                            <li>Like being in a movie theatre</li>
                            <li>Less expensive than older</li>
                        </ul>
					</div>
				</div>
			</div>
