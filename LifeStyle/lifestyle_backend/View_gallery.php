...
?> 
       ...
       <td><?php echo $row['title']; ?></td>
          <td><?php echo "<img src=" . $row['image'] ." width=100  height=100/>"; ?></td>
             ...
             <td><a href="edit_gallery.php?id=<?php echo $row['gallery_id']; ?>">Edit</a></td>
       <td><form method="post">
...
echo "<a href='View_gallery.php?page=1'>".'|<'."</a> "; // Goto 1st page  

for ($i=1; $i<=$total_pages; $i++) { 
            echo "<a href='View_gallery.php?page=".$i."'>".$i."</a> "; 
}
echo "<a href='View_gallery.php?page=$total_pages'>".'>|'."</a> "; // Goto last page
?>
