...
$sql = "SELECT * FROM testimonals  LIMIT $start_from, $num_rec_per_page"; 
...
echo "<a href='View_testimonals.php?page=1'>".'|<'."</a> "; // Goto 1st page  

for ($i=1; $i<=$total_pages; $i++) { 
            echo "<a href='View_testimonals.php?page=".$i."'>".$i."</a> "; 
}
echo "<a href='View_testimonals.php?page=$total_pages'>".'>|'."</a> "; // Goto last page
?>
