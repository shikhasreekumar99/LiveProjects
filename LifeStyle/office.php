	...
	<div class="c-layout-breadcrumbs-1 c-bgimage c-subtitle c-fonts-uppercase c-fonts-bold c-bg-img-center" style="background-image: url(images/bg-1.gif)">
		<div class="container">
			<div class="c-page-title c-pull-left">
				<h3 class="c-font-uppercase c-font-bold c-font-white c-font-20 c-font-slim">Office, Shop & Commercial Building Furnishing</h3>
				<h4 class="c-font-white c-font-thin c-opacity-07">
				Lifestyle Interio, Office, Shop & Commercial Building Furnishing</h4>
			</div>
			<ul class="c-page-breadcrumbs c-theme-nav c-pull-right c-fonts-regular">
				...
				<li class="c-state_active c-font-white">
					Office, Shop & Commercial Building Furnishing
				</li>
			</ul>
		</div>
	</div>
            	...
            	<div class="col-md-6">
					<div class="c-content-media-2-slider" data-slider="owl" data-single-item="true" data-auto-play="3000">
						...
						<div class="owl-carousel owl-theme c-theme owl-single">
							<div class="item">
								<div class="c-content-media-2 c-bg-img-center" style="background-image: url(images/service-19.jpg); min-height: 380px;">
								</div>
							</div>
							<div class="item">
								<div class="c-content-media-2 c-bg-img-center" style="background-image: url(images/service-20.jpg); min-height: 380px;">
								</div>
							</div>
							<div class="item">
								<div class="c-content-media-2 c-bg-img-center" style="background-image: url(images/service-21.jpg); min-height: 380px;">
								</div>
							</div>
						</div>
					</div>
                 ...
                 <div class="col-md-6">
                 	<h3 class="c-left c-font-red">Our services</h3>
                    <ul class="c-content-list-1"> 
                        <li>Workstations and chairs </li>
                        <li>Partitions </li>
                        <li>Flooring (Wooden, Carpet or Vitrified tiles)</li>
                        <li>False ceiling </li>
                        <li>Painting</li>
                        <li>Blinds</li>
                    </ul>
