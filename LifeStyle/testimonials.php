...
<div class="c-layout-page">
	...
	<div class="c-layout-breadcrumbs-1 c-bgimage c-subtitle c-fonts-uppercase c-fonts-bold c-bg-img-center" style="background-image: url(images/bg-1.gif)">
		<div class="container">
			<div class="c-page-title c-pull-left">
				<h3 class="c-font-uppercase c-font-bold c-font-white c-font-20 c-font-slim">Testimonials</h3>
				<h4 class="c-font-white c-font-thin c-opacity-07">
				What our clients say about us</h4>
			</div>
  ...
  <?php $sql="SELECT * FROM `testimonals`";
        ...
        ?>
             ...
             <div class="col-md-4">
                	<div class="testimonial-outer">
                        ...
                        <div class="testimonial-client"><strong>- <?php echo $row['name']; ?></strong><br><?php echo $row['place']; ?></div>
                        </div>
                    </div>
                </div>   
