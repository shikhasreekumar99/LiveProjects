	...
	<div class="c-layout-breadcrumbs-1 c-bgimage c-subtitle c-fonts-uppercase c-fonts-bold c-bg-img-center" style="background-image: url(images/bg-1.gif)">
		<div class="container">
			<div class="c-page-title c-pull-left">
				<h3 class="c-font-uppercase c-font-bold c-font-white c-font-20 c-font-slim">Turnkey Interior</h3>
				<h4 class="c-font-white c-font-thin c-opacity-07">
				Lifestyle Interio, Turnkey Interior </h4>
			</div>
			...
			<div class="row">
            	<div class="col-md-6">
					<div class="c-content-media-2-slider" data-slider="owl" data-single-item="true" data-auto-play="3000">
						...
						<div class="owl-carousel owl-theme c-theme owl-single">
							<div class="item">
								<div class="c-content-media-2 c-bg-img-center" style="background-image: url(images/service-1.jpg); min-height: 380px;">
								</div>
							</div>
							<div class="item">
								<div class="c-content-media-2 c-bg-img-center" style="background-image: url(images/service-2.jpg); min-height: 380px;">
								</div>
							</div>
							<div class="item">
								<div class="c-content-media-2 c-bg-img-center" style="background-image: url(images/service-3.jpg); min-height: 380px;">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-md-6">
					<div class="c-content-media-1 p0">
						<p>Opting for integrated turnkey solutions of Lifestyle Interio ensures a single point of contact for interiors, thereby, minimising the risk of dealing with multiple suppliers. Turnkey, as the name suggests is all about providing end to end services to design and build your interiors. A bare-shell apartment, villa, office or commercial space is turned into a fully functional residence, office, shop or showroom as per the client's requirements. </p><p>It would also include appropriate and quality sourcing of materials. Single point sourcing for all the requirements help provide effective control and management during the course of any project. </p>
                        <h3 class="c-left c-font-dark">The solutions include: </h3>
                        <div class="col-md-12">
                        	<div class="col-md-6 p0">
                            	<p class="c-font-bold">For residence</p>
                            ...
                            <div class="col-md-6">
                            	<p class="c-font-bold">For offices & showrooms</p>
                            	<ul class="c-content-list-1">
								<li>
									Planning & consulting
								</li>
                ...
                <h3 class="c-left c-font-dark">ADVANTAGES OF TURNKEY SOLUTIONS</h3>
                <p>One-stop solution: This is the biggest advantage of turnkey solutions for your interiors. Right from understanding your design to sharing the blueprint; from procurement of raw materials to manpower management; from maintaining high standards of quality control to delivering the finished project on time, turnkey solutions ensure professional expertise with no coordination hassles and different contractors for each job. This also makes the payment process much easier, apart from escaping the turmoil of explaining your design to each contractor and hoping that all of it comes together in the end result. </p>
                 <h3 class="c-left c-font-dark">TIMELY DELIVERY</h3>
                 <p>Turnkey projects do not overshoot the timeline as a master plan is created at the onset of every project to ensure systematic implementation. This master plan aids in effective labour and material management. All the details are finalised at the very beginning with the client.</p>
                  <h3 class="c-left c-font-dark">NO OVERSHOOTING OF BUDGET</h3>
                  <p>Since all the design details and material specifications are finalised prior to the execution and the quote is shared with the client beforehand, there are fewer chances of budgets overshooting. Changes in design and material suggested by clients during the course of the execution, can lead to an increase in price. Turnkey projects are also highly cost-effective due to the speedy completion of projects and pre-fixed rates with vendors and contractors.  </p>
			</div>
		</div>
	</div>
