	...
	<div class="c-layout-breadcrumbs-1 c-bgimage c-subtitle c-fonts-uppercase c-fonts-bold c-bg-img-center" style="background-image: url(images/bg-1.gif)">
		<div class="container">
			<div class="c-page-title c-pull-left">
				<h3 class="c-font-uppercase c-font-bold c-font-white c-font-20 c-font-slim">Wardrobes</h3>
				<h4 class="c-font-white c-font-thin c-opacity-07">
				Lifestyle Interio, Wardrobes</h4>
			</div>
			...
			<div class="row">
            	<div class="col-md-6">
					<div class="c-content-media-2-slider" data-slider="owl" data-single-item="true" data-auto-play="3000">
						...
						<div class="owl-carousel owl-theme c-theme owl-single">
							<div class="item">
								<div class="c-content-media-2 c-bg-img-center" style="background-image: url(images/service-7.jpg); min-height: 380px;">
								</div>
							</div>
							<div class="item">
								<div class="c-content-media-2 c-bg-img-center" style="background-image: url(images/service-8.jpg); min-height: 380px;">
								</div>
							</div>
							<div class="item">
								<div class="c-content-media-2 c-bg-img-center" style="background-image: url(images/service-9.jpg); min-height: 380px;">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-md-6">
					<div class="c-content-media-1 p0">
						<p>A wardrobe in a room signifies the personality of a person, as the style of arrangement portrays on how organised a person is. Well organised closets all over a home make a home look neat and structured. </p>
                        <p><strong>The colour factor:</strong> It is always important that you compliment your room decor with a matching wardrobe colour. You can also choose different bright colours which can blend well with your room decor. If your wardrobe is white coloured, you can opt for soft pastel colours or the colour of your floor mat. If it’s a huge wardrobe, opt for palette and earthy neutral colours.</p>
                       <p><strong>Lighting up your wardrobe:</strong> Any style of lighting is installed properly can make anything look better. You can use the lights in the wardrobe. Mostly warm white or cool white lights can be used to make your wardrobe look attractive.</p>
					</div>
				</div>
			</div>
		</div>
