<?php
		...
		ob_start();
			...
			$your_Email = "magictainments@gmail.com";

			$mailer->From ='magictainments@gmail.com';
              

			$mailer->FromName ='Nipin Niravath';  
			...
			<tr><td align=right><b>Contact:&nbsp;</b></td><td>".$_POST['contact']."</td></tr>
