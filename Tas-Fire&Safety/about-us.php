...
<section class="breadcrumb-wrap">
  ...
  <div class="container pdngtop">
    ...
    <small><a href="index.php">Home</a> / About Us</small> </div>
      ...
      <div class="row">
        ...
        <div class="col-md-12 feature-list">
          ...
          <div class="row">
            ...
            <div class="col-sm-9">
              ...
              <div class="row">
                ...
                <div class="col-sm-12">
                  ...
                  <p><span class="dropcap2 img-circle">W</span>

                  <p class="palign">e are a leading Fire & Security  company located in Hamilton(ON) provides various products and services throughout Ontario. Our core focus is for fire & safety which provide monthly& annual inspection, certification, deficiency repairs, preventive and corrective maintenance of Fire Alarm, Fire Protection Equipment, Fire Extinguishers, Emergency Lighting, Sprinkler Systems, Intercoms, Access control, Security alarm, Monitoring service, Smoke Alarms, CO2 Alarms, Time distribution, TV Distribution, Public Address, Access Control and Cameras. We provide Re-lambing, Electrical and Pot Lights Service. We provide service to residential and commercial properties as per building code, fire code, electrical code and ULC Standards.</p>

                  <p class="palign">Our fully licensed CFAA technicians, 309A licensed electricians, sprinkler fitters, factory trained fire protection and suppression technicians provide quality & timely service and advise to ensure your safety. We ensure very competitive rates in the area and provide price beat guarantee for all our products and services.</p>

                  </p>

                </div>

                <div class="col-sm-12 pdngtop">
                  ...
                  <div class="theme-tab">
                    ...
                    <div class="tabbable">
                      ...
                      <ul id="tab" class="nav nav-tabs">
                        ...
                        <li class="active"> <a href="#tab-content-2" data-toggle="tab" aria-expanded="false">

                          <h2>Our Vision</h2>

                          </a></li>

                        <li class=""> <a href="#tab-content-5" data-toggle="tab" aria-expanded="true">
                      ...
                      <div id="tab-content" class="tab-content">
                        ...
                        <div id="tab-content-1" class="tab-pane fade">
                          ...
                          <p class="no-mg-b">Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Nunc non mollis nulla. Sed consectetur elit id mi consectetur bibendum. Ut enim massa, sodales tempor convallis</p>

                        </div>

                        <div id="tab-content-2" class="tab-pane fade active in">
            ...
            <div class="col-sm-3"> <img src="images/inner_img.jpg" class="img-responsive hvr-rotate" alt="Responsive image"> </div>
