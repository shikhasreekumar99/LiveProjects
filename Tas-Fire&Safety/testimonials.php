...
<?php require_once('tas_backend/db.php');?>
          ...
          <div class="col-sm-12">
            <div id="main-menu" class="menuzord"> <a href="javascript:void(0)" class="menuzord-brand"><img src="images/logo.jpg" alt="TAS Fire & Security"></a>
              <ul class="menuzord-menu">
                ...
                <li class="active"><a href="testimonials.php"><span>Testimonials</span></a> </li>
...
<section class="breadcrumb-wrap">
  <div class="container pdngtop">
    <h1>TESTIMONIALS</h1>
    <small><a href="index.php">Home</a> / Testimonials</small> </div>
</section>
<!-- xxx Callout 1 xxx --> 
...
<div id="body-content" class="no-margin home"> 
  ...
  <section class="service-icons m50">
    <div class="container">
	 ...
	 <img class="media-object img-rounded img-responsive" src="tas_backend/<?= $row['image'];  ?>"> </div>
                      <div class="col-md-10 col-sm-10 col-xs-12">
                        <div class="caption">
                          <p class="text-info lead adjust2"><?=$row['title'];?></p>
                          <p><span class="glyphicon glyphicon-thumbs-up"></span><?=$row['description'];?></p>
                          <blockquote class="adjust2">
                            <p><?=$row['name'];?></p>
                            <small><cite title="Source Title"><i class="glyphicon glyphicon-globe"></i> <?=$row['website'];?>
                            </cite></small> 
                            </blockquote>
                        </div>
                      </div>
       ...
       <?php
        ...
        <div class="col-sm-3"> <img src="images/testimonial.jpg" class="img-responsive hvr-rotate" alt="Responsive image"> </div>
      </div>
    </div>
  </section>
