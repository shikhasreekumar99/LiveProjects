...
<script>document.body.className += ' fade-out';</script>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="login.php"><img class="img-fulid" src="images/logo.png" alt="RIT" style="width:50px" id='Logo'></a></a><h3 style="color :#007bff ; font-family: 'Berkshire Swash', cursive;" ><span style="color :white;">RIT</span>Soft <span style="color :red;">v2</span></h3>
