            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        $r=mysqli_query($con,"select name from faculty_details where fid='$hodid'");
                        while($d=mysqli_fetch_array($r))
                        {
                            $fname=$d["name"]; 
                            echo $fname; 
                            echo '<a href="dash_home.php"></a>';
                        }                        
                    ?>                        
                        ...
                        <li>                        
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="suballoc_view.php"> Subject Allocation</a>
                                </li>
                        ...
                        <li>
                            <a href="hod-search/search-form.php"><i class="fa fa-table fa-fw"></i>STUDENT SEARCH</a>
                        </li>
                        <li>
                       ...
                       <li>
                            <a href="search_form.php"><i class="fa fa-edit fa-fw"></i> CERTIFICATE </a>
                        </li>
