...
<?php
 $sql ="select * from faculty_details where deptname in(select deptname from department where hod='$hodid');";
...
?>
			...
			<td><a href="deletestaff.php?staffid=<?php echo $staffid;?>" onclick="return checkDelete()" >DELETE</a></td>
			</tr>
<?php
		}
	 }
