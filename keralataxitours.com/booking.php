...
<title>book a taxi kochi/cochin/ernakulam | book a bus/traveller kochi | Taxi service kochi | taxi operator kochi | cab hire kochi | tour operator cochin | taxi tours ernakulam | hire a taxi kochi | car hire kochi | rent a car kochi | car rentals kochi | rental services kochi/cochin/ernakulam | kerala taxi tours kochi/cochin/ernakulam </title>
				...
				<div id="header">
					...
					<div class="logo_right">
							<div class="menu">
									...
									<div class="con" align="center"><a href="contact.html" class="menu_font">Contact Us</a></div>
							</div>
							<div class="clear"></div>
							<div class="pho">
...
?>
														...
														<tr >
																	<td height="30"><span class="hed_font"><?php echo $arrval[3];?></span></td>
																	<td>&nbsp;</td>
																	<td>&nbsp;</td>
																	<td>&nbsp;</td>
														  </tr>
														...
														<tr >
																	<td width="37%" style="height:150px;" align="left">
																	<img src="<?php echo $arrval[0];?>" border="0" title="Indica" /></td>	
																	<td width="3%">&nbsp;</td>	
																	<td style=" padding-left:15px;"> <h3>Per Day</h3>
				
                 <div> <span class="style11">
                   <label><strong>A/c:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></label>
                 </span>
                    <span><b><?php echo $arrval[1];?></b></span> 
					 <?php
					  if($arrval[5] != "0")
					  {
					  ?>
					    <br />
						<span class="style11">
                   <label><strong>Non A/c:</strong></label>
                 </span>
                    <span><b><?php echo $arrval[5];?></b></span> 
					  <?php
					  }
					?>               </div>
                ...
                <h3>Rate for Additional Km</h3>

                <div> <span class="style11">
                  <label><strong>A/c:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></label>
                </span>                    <span><b><?php echo $arrval[2];?></b> </span>
				 ...
				 <?php
                   ...
                   <label><strong>Non A/c:</strong></label>
                    ...
                    <span><b><?php echo $arrval[6];?></b></span> 
					  <?php
					  }
					?>        
				                 </div>         </td>	
...
<optgroup label="Cars"><option value="tataindica">Tata Indica</option><option value="tataindigo">Tata Indigo</option><option value="logan">Verito</option><option value="swiftdzire">Swift Dzire</option><option value="toyotainnova">Innova</option><option value="tavera">Tavera</option><option  value="corolla">Corolla</option><option value="xylo">Xylo</option><option value="skoda">Skoda</option><option value="benz">Benz</option></optgroup><optgroup label="Tempo Traveller"><option value="12-14-seater">12/14 seater</option><option value="17-seater">17 seater</option></optgroup><optgroup label="Bus"><option value="32-seater">32 seater Bus</option><option value="35-39-seater">35-39 seater Bus</option><option value="35-39-seater-pushback">35 Pushback</option></optgroup>                </select> 
	...
	<option value="One Way">Rs 3500  and above </option>
																...
																<tr>
																	<td >&nbsp;</td>
																	<td>&nbsp;</td>
																	<td><input aria-disabled="false" role="button" name="submit" class="button ui-button ui-widget ui-state-default ui-corner-all" value="submit" type="submit" onclick="return validateContact(Vehicle.value,dept_date_dd.value,dept_date_mm.value,dept_date_yyyy.value,arr_date_dd.value,arr_date_mm.value,arr_date_yyyy.value,Adult.value,Children.value,journeytype.value,Name.value,Email.value,Phone.value,City.value);"></td>
																	<td>&nbsp;</td>
																</tr>
														</table>
														</form>
...
<td>
<p><a  class="link_color" href="http://keralataxitours.com/about.html">Taxi service cochin</a></p>
</td>
<td>
...
Website by : <a href="http://www.phitany.com/" class="footer_link" target="_blank" title="Phitany">Phitany</a> and <a href="http://g3creativestudios.com/" class="footer_link" target="_blank" title="G3 Creative Studio">G3 Creative Studio</a> </span></div>
							...
							<div class="footer_inner" align="right">
							<span class="footer_font"> <a href="index.html" class="footer_link">Home</a>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<a href="about.html" class="footer_link">About Us</a>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<a href="car.html" class="footer_link">Packages</a>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<a href="contact.html" class="footer_link">Contact Us</a></span>
							</div>
						</div>
		</div>
</body>
