...
<div class="site_wrapper">
  ...
  <div class="container_full"> 
    ...
    <div id="transition-timer-carousel" class="carousel slide transition-timer-carousel" data-ride="carousel"> 
	  ...
	  <div class="item active "> <img src="images/healthbnr.jpg" />
        ...
        <div class="item"> <img src="images/munnar.jpg" />
          <div class="carousel-caption">
          
          </div>
        </div>
        <div class="item"> <img src="images/kovalam.jpg" />
          <div class="carousel-caption">
            
          </div>
        </div>
        <div class="item"> <img src="images/kalpeni.jpg" />
          <div class="carousel-caption">
        ...
        <div class="item"> <img src="images/fourth.jpg" />
          <div class="carousel-caption">
  ...
  <div class="content_fullwidth">
    <div class="container">
      <h2 class="ipages_title1 two"><strong>CUTE DESTINATIONS</strong> </h2>
      <h3>LEISURE</h3>
      ...
      <!--LEISURE-->
        ...
        <?php
	   $data="SELECT * FROM `cute_leisure`";
	   $query=mysqli_query($con,$data);
	   
	   foreach($query as $leisure){
        ...
        <div class="framed-box">
          <div class="framed-box-wrap">
            <div class="pricing-title">
              <h4 class="nocaps">
            <?=$leisure['cute_leisure'];?>
              </h4>
            </div>
            <div class="pricing-text-list">
              <ul class="list1">
              
              <?php $leisure_id = $leisure['cute_id'];
			  
			  	   $dest1="SELECT * FROM `leisure_destination` where `cute_id`='$leisure_id'";
	               $subquery1=mysqli_query($con,$dest1);
	   
	               foreach($subquery1 as $list1){
			  ?>
              
                <li><i class="fa fa-chevron-circle-right"></i> <?=$list1['places'];?></li>
      ...
      <?php
	   ...
	   ?>
        ...
        <div class="one_fifth">
        <img src="images/cute_img1.jpg" alt="">
      </div>
    ...
    <div class="container">
      ...
      <!--LEISURE-->
        ...
        <?php
	   $data2="SELECT * FROM `cute_adventure`";
	   $query2=mysqli_query($con,$data2);
	   
	   foreach($query2 as $adventure){
          ...
          <div class="framed-box-wrap">
            ...
            <div class="pricing-text-list">
              ...
              <?php 
				   ...
				   $adventure_id = $adventure['cute_ad_id'];
			  
			  	   $dest2="SELECT * FROM `adventure_destination` where `cute_ad_id`='$adventure_id'";
	               $subquery2=mysqli_query($con,$dest2);
	   
	               foreach($subquery2 as $list2){
			  ?>
              
                <li><i class="fa fa-chevron-circle-right"></i> <?=$list2['places'];?></li>
      ...
      <div class="one_fifth">
        <img src="images/cute_img2.jpg" alt="">
      </div>
