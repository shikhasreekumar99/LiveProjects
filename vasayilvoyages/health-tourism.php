...
<div class="site_wrapper">
  ...
  <div class="container_full"> 
    ...
    <div id="transition-timer-carousel" class="carousel slide transition-timer-carousel" data-ride="carousel"> 
      ...
      <div class="carousel-inner">
        ...
        <div class="item"> <img src="images/mdrnmedcn.jpg" />
          <div class="carousel-caption">
            <h1 class="carousel-caption-header">Modern Medicine</h1>
          </div>
        </div>
        <div class="item"> <img src="images/ayurveda_banner.jpg" />
          <div class="carousel-caption">
            <h1 class="carousel-caption-header">Ayurvedic Medicine</h1>
          </div>
        </div>
        <div class="item"> <img src="images/health_banner3.jpg" />
          <div class="carousel-caption">
            <h1 class="carousel-caption-header">UNANI, HOMEOPATHY AND NATUROPATHY</h1>
          </div>
        </div>
        <div class="item"> <img src="images/health_banner5.jpg" />
          <div class="carousel-caption">
            <h1 class="carousel-caption-header">DENTRAL TREATMENT</h1>
          </div>
        </div>
      </div>
  ...
  <div class="content_fullwidth">
    <div class="container">
      <h2 class="ipages_title1 two"><strong>HEALTH</strong> TOURISM</h2>
      <div class="one_third ">
        <div class="row">
          <h3 class="ipages_title1"><strong>TREATMENT</strong> </h3>
          <div class="update-nag">
            <div class="update-split"><i class="fa fa-arrow-right"></i></div>
            <div class="update-text"> <a href="modern-medicine.html">Modern Medicine</a> </div>
          </div>
          <div class="update-nag">
            <div class="update-split update-info"><i class="fa fa-arrow-right"></i></div>
            <div class="update-text"><a href="ayurveda.html">Ayurveda</a> </div>
          </div>
          <div class="update-nag">
            <div class="update-split update-success"><i class="fa fa-arrow-right"></i></div>
            <div class="update-text"> <a href="UnaniandNaturopathy.html"> Unani, Homeopathy and Naturopathy</a> </div>
          </div>
          <div class="update-nag">
            <div class="update-split update-danger"><i class="fa fa-arrow-right"></i></div>
            <div class="update-text"> <a href="dental.html">Dental</a> </div>
          </div>
        </div>
      </div>
      <!-- end section -->
      ...
      <div class="two_third last">
           ...
           <?php
	   $note="SELECT * FROM `note` where `note_id`='1'";
	   $query=mysqli_query($con,$note);
      ...
      <?=$data['description'];?>
	   ...
	   ?>
        ...
        <p><a href="form.html" class="but_book"><i class="fa fa-book fa-lg"></i> Book a package</a></p>
      </div>
      <!-- end section --> 
