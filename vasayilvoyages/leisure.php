...
<div class="site_wrapper">
  ...
  <div class="container_full"> 
    ...
    <div id="transition-timer-carousel" class="carousel slide transition-timer-carousel" data-ride="carousel"> 
	  ...
	  <div class="item active"> <img src="images/healthbnr.jpg" />
        ...
        <div class="item"> <img src="images/leisure1.jpg" />
          <div class="carousel-caption">
         <h1 class="carousel-caption-header">Hill Stations</h1>
          </div>
        </div>
        <div class="item"> <img src="images/leisure2.jpg" />
          <div class="carousel-caption">
           <h1 class="carousel-caption-header">Water Falls</h1>
          </div>
        </div>
        <div class="item"> <img src="images/leisure3.jpg" />
          <div class="carousel-caption">
          <h1 class="carousel-caption-header">House Boat</h1>
          </div>
        </div>
        <div class="item"> <img src="images/leisure4.jpg" />
          <div class="carousel-caption">
           <h1 class="carousel-caption-header">Beaches</h1>
          </div>
        </div>
  ...
  <div class="content_fullwidth">
    <div class="container">
      <h2 class="ipages_title1 two"><strong>LEISURE</strong> </h2>
      
      
         <?php
	   $note="SELECT * FROM `note` where `note_id`='2'";
      ...
      <?=$data['description'];?>
	   ...
	   ?>
<p><a href="leisure-package.html" class="but_book"><i class="fa fa-book fa-lg"></i> Book a package</a></p>
      </div>
      <!-- end section --> 
