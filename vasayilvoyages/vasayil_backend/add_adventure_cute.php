...
if(isset($_POST['submit']))
  { 
	...
	$res="INSERT INTO `cute_adventure`(` cute_adventure`) VALUES ( '$adventure')";
          ...
          <div class="box">
            <div class="box-header with-border">
                <form name="add_form" id="add_form" method="post" action="" >
                  ...
                  <p><label> Adventure*</label>
                    <textarea name="adventure" id="adventure" class="form-control required"></textarea>
    	<p>
