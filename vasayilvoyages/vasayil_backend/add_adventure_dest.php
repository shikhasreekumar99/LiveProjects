...
if(isset($_POST['submit']))
{
	...
	$place=$_POST['place'];
			 ...
			 $query=mysqli_query($con,"INSERT INTO `adventure_destination`( `cute_ad_id`, `places`) VALUES ('$adventure','$place')");
   ...
   <?php require_once('menu.php'); ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
                ...
                <form name="add_form"  id="add_form" method="post" action="" >
                 ...
                 <select name="adventure"  class="form-control required" > 
         ...
         <option value="<?php echo $row['cute_ad_id'];?>"><?=$row['cute_adventure']?></option>
