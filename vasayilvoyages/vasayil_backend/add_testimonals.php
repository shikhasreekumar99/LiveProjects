...
/*	   if(isset($_FILES["photo"]))
{
      ...
      // $image_height = $image_info[1];
       ...
       $res="INSERT INTO `testimonals`( `title`,`name`) VALUES ( '$title' ,'$name')";
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
         ...
         <textarea type="text" name="title" id="title" class="form-control required"></textarea></p>
         
          <p><label> Name*</label>
         <textarea type="text" name="name" id="name" class="form-control required"></textarea></p>
