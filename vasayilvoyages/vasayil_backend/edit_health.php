...
if(isset($_POST["submit"]))
{
	$description=$_POST['description'];	
     ...
     $res="UPDATE `note` SET `description`='$description' WHERE `note_id`='1' ";
	// echo $res;
	 //die();
   ...
   { 
     ...
     $res="UPDATE `note` SET image='$photo' WHERE `note_id`='1'";
	// echo $res;
	 //die();
			$sql=mysqli_query($con,$res);			
			if($sql)
...
<head>
 ...
 <!-- Site wrapper -->
   ...
   $data="SELECT * FROM `note` where `note_id`='1'";
 ...
 while ($row=mysqli_fetch_array($query))
   ...
   <p> <label>Description*</label>
    <textarea name="description"  class="ckeditor form-control" id="description" cols="80"><?php echo $row['description'];?></textarea></p>
